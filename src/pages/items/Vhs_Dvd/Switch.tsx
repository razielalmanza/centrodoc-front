  ...
  const selector = () => {
    switch(action){
      case 'menu':
        ...
        break;
      case 'agrega':
        setCurrentPermissionNeeded([Permisos.UNICA_WRITE]);
        setElementToShow(<Agrega/>);
        break;  
      case 'detalles':
        setCurrentPermissionNeeded([Permisos.UNICA_READ]);
      ...
      default: 
        setCurrentPermissionNeeded([]);
        setElementToShow(<NotFound errorMessage={`No existe la acción en Vhs Dvd: ${action}`}/>);
        break;
    }
  }
