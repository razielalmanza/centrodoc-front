  ...
  const selector = () => {
    switch(action){
      case 'menu':
        ...
        break;
      case 'agrega':
        setCurrentPermissionNeeded([Permisos.CARTEL_WRITE]);
        setElementToShow(<Agrega/>);
        break;  
      case 'busca':
        setCurrentPermissionNeeded([Permisos.CARTEL_READ]);
      ...
      default: 
        setCurrentPermissionNeeded([]);
        setElementToShow(<NotFound errorMessage={`No existe la acción en Carteles: ${action}`}/>);
        break;
    }
  }
