...
import { Agrega, Asocia, Busca, Detalles, Edita } from ".";
  ...
  const selector = () => {
    switch(action){
      ...
      case 'busca':
        ...
        break;
      case 'detalles':
        setElementToShow(<Detalles nombre={id}/>);
        break;
      case 'edita':
      ...
      case 'desasocia':
        ...
        break;
      default: 
        setElementToShow(<NotFound errorMessage={`No existe la acción en Interpretes: ${action}`}/>);
        break;
    }
  }
